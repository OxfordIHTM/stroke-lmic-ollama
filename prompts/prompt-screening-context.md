...
age_group: NULL
geography: TRUE
geography_name: Ethiopia
publication_type: FALSE
publication_type_name: scoping review
topic: TRUE
topic_name: prevalence
...
publication_type_name: retrospective cohort study
topic: TRUE
topic_name: risk factors, morbidity
