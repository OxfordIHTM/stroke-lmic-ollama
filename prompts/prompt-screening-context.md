...
1. The study should be of an adult population or participants. 
    ...
    it describes the study as a *"retrospective cohort study of adults (>= 18 years)"* which specifies an adult age grouping of the study participants. This study meets the criteria for the study population.
    ...
    it describes the study as a *"multicenter registry-based cohort study with an emulated target trial design included consecutive adult patients"* which specifies the participants as being **adults**. This study meets the criteria for the study population.
