...
llm_create_screening_type <- function() {
  ellmer::type_array(
    ellmer::type_object(
      ...
      uid = ellmer::type_string(description = "Unique Identifier with 8 characters the first two of which are either EB, GH, or ML and the last 6 are numbers."),
      ...
      study_type_criteria = ellmer::type_boolean(
      ...
      topic_context = ellmer::type_array(
        ellmer::type_string(description = "Study topic about stroke")
      ),
      topic_criteria = ellmer::type_boolean(
