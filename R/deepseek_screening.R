#'
#' Screen the search articles using Ollama Deepseek
#' 
#' 

deepseek_screen_articles <- function(deepseek_reviewer, query) {
  ...
  out <- deepseek_reviewer$chat_structured(query, type = type_classification)
