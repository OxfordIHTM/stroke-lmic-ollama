...
create_screening_context_prompt <- function(wb_lmic_lic_prompt) {
  criteria <- c(
    ...
    "Second criteria is that the study should be on a population living in lower-middle income (LMIC) or low income countries (LIC) based on the most recent World Bank country classification by income level. These countries are",
    wb_lmic_lic_prompt,
